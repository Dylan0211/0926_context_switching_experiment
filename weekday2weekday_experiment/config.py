...
a_gen_a_save_path = './models/weekday2weekday_train_set_a_gen_a.pt'
a_gen_b_save_path = './models/weekday2weekday_train_set_a_gen_b.pt'
b_gen_a_save_path = './models/weekday2weekday_train_set_b_gen_a.pt'
b_gen_b_save_path = './models/weekday2weekday_train_set_b_gen_b.pt'
c_gen_a_save_path = './models/weekday2weekday_train_set_c_gen_a.pt'
c_gen_b_save_path = './models/weekday2weekday_train_set_c_gen_b.pt'
