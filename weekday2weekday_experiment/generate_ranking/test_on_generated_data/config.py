...
# note: specify which GAN to use
GAN_building_name = 'c'
gen_a_save_path = '../../models/weekday2weekday_train_set_{}_gen_a.pt'.format(GAN_building_name)
gen_b_save_path = '../../models/weekday2weekday_train_set_{}_gen_b.pt'.format(GAN_building_name)
