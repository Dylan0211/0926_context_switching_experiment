...
def load_data():
    ...
    with open('./tmp_pkl_data/{}_ashrae_{}_gt.pkl'.format(target_building_name, source_context), 'wb') as w:
        pickle.dump((X, Y, load_max, load_min), w)
    print('model saved: ./tmp_pkl_data/{}_ashrae_{}_gt.pkl'.format(target_building_name, source_context))
    print()
