...
def test_a_b_c_on_target_building():
    ...
    gen_a_on_a_building.load_state_dict(torch.load('models/weekend2weekend_train_set_a_gen_a.pt'))
    gen_b_on_a_building = Generator()
    gen_b_on_a_building.load_state_dict(torch.load('models/weekend2weekend_train_set_a_gen_b.pt'))
    gen_a_on_b_buildings = Generator()
    gen_a_on_b_buildings.load_state_dict(torch.load('models/weekend2weekend_train_set_b_gen_a.pt'))
    gen_b_on_b_buildings = Generator()
    gen_b_on_b_buildings.load_state_dict(torch.load('models/weekend2weekend_train_set_b_gen_b.pt'))
    gen_a_on_c_buildings = Generator()
    gen_a_on_c_buildings.load_state_dict(torch.load('models/weekend2weekend_train_set_c_gen_a.pt'))
    gen_b_on_c_buildings = Generator()
    gen_b_on_c_buildings.load_state_dict(torch.load('models/weekend2weekend_train_set_c_gen_b.pt'))
